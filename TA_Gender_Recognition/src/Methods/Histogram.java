...
//        Mat img = bhep.getBHEP(GUI.PATH_HEADER_DATASET + "manual_crop_male\\face_11.jpg");
//        Imgproc.cvtColor(img, img, Imgproc.COLOR_RGB2GRAY);
//        return bhep.mat2Img(img);

        try {
            File f1 = new File(GUI.PATH_HEADER_DATASET + "manual_crop_male\\face_11.jpg");
            return getGrayscaleImage(ImageIO.read(f1));
        } catch (IOException e) {
    ...
    private ChartPanel createChartPanel() {
        ...
        // chart
        JFreeChart chart = ChartFactory.createHistogram("Histogram", "CT Value",
